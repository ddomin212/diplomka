...
%\TULconsultant{doc. RNDr. Třetí Konzultant, Ph.D
    ...
    Chtěl bych nejdříve poděkovat Ing. Romanu Špánkovi Ph.D. za vypsání takto zajímavého a netradičního tématu, a za validaci prvních prototypů aplikace i práce jako takové. Dále bych chtěl poděkovat OpenAI, za to, že svůj model ChatGPT dává bez omezení volně k dispozici, a tím pádem byla možnost takovou práci vůbec vytvořit. To samé platí pro platformu Huggingchat, která mi posktyla zázemí pro testování open source modelů, které bych nemohl lokálně spustit. V neposlední řadě chci poděkovat mnoha YouTube kanálům, které mi pomohli pochopit, jak fungují velké jazykové modely do velice podrobné úrovně, a rodině a přátelům za validaci práce a podporu při jejím psaní.
    \end{acknowledgement}
